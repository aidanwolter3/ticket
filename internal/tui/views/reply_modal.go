...
func NewReplyModal(threadID string) *ReplyModal {
	...
	return &ReplyModal{authorIn: author, textIn: text, threadID: threadID}
}

func (m *ReplyModal) Init() tea.Cmd { return textinput.Blink }
